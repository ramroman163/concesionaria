...
public class Edicion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("EDICIÓN DE AUTOS");
        ...
        labelEdit.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        ...
        btnEditLayout.setHorizontalGroup(
            ...
            .addComponent(labelEdit, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
        );
        btnEditLayout.setVerticalGroup(
            btnEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(labelEdit, javax.swing.GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE)
        );
    ...
    private void labelEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelEditMouseClicked
        ...
        control.editar(auto, color, marca, modelo, patente, puertas, motor);
        
        mostrarMensaje("Se ha editado correctamente", "info", "Edición de automóviles");
    ...
    private void cargaDatos(int id_auto) {
        auto = control.obtenerAuto(id_auto);
